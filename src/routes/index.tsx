    ...
    <main className="min-h-screen w-full px-5 pb-8 pt-3" style={{ backgroundColor: "#FDF6EC" }}>
      <div className="mx-auto w-full max-w-md">
        ...
        <section className="relative text-center">
          ...
          <p className="jc-font jc-teal text-[13px]" style={{ textShadow: "4px 4px 0px #1a1a1a" }}>Join 12,000+ Jellycat Insiders</p>
          <h1 className="jc-font mt-1 text-[26px] leading-[1.15]" style={{ textShadow: "4px 4px 0px #1a1a1a" }}>
        ...
        <section className="mt-4">
          <p className="jc-font jc-teal text-center text-[11px] tracking-[0.18em]" style={{ textShadow: "4px 4px 0px #1a1a1a" }}>HOW IT WORKS</p>
            ...
            {STEPS.map((s, i) => (
              ...
              >
                <span
                  ...
                  style={{ background: "#2BBCD4", boxShadow: "4px 4px 0px #1a1a1a", textShadow: "4px 4px 0px #1a1a1a" }}
                >
                  {i + 1}
                </span>
