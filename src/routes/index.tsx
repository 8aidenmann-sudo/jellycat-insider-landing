    ...
    <main className="min-h-screen w-full px-5 pb-8 pt-3" style={{ backgroundColor: "#FDF6EC" }}>
      <div className="mx-auto w-full max-w-md">
        ...
        <section className="mt-4">
          <p className="jc-font jc-teal text-center text-[11px] tracking-[0.18em]" style={{ textShadow: "1.25px 1.25px 0px #0a0a0a" }}>HOW IT WORKS</p>
            ...
            {STEPS.map((s, i) => (
              ...
              >
                <span
                  ...
                  style={{ background: "#2BBCD4", boxShadow: "2px 2px 0px #0a0a0a", textShadow: "2px 2px 0px #0a0a0a" }}
                >
                  {i + 1}
                </span>
